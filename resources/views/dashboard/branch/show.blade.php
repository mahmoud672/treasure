...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Branch Images
            <small>All Branch Images</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{adminUrl("")}}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{adminUrl("/branch")}}">Branch</a></li>
            <li class="active">All Branch Images</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary" style="padding: 15px">
                    <div class="box-header with-border">
                        <h3 class="box-title">All Images For This Branch</h3>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Are You Sure You Want To Delete This Image of <strong>{{$branch->id}}</strong></p>
                                </div>
                                <div class="modal-footer">
                                    <form action="{{adminUrl("branch")}}/show/{{$branch->id}}/deleteImage" method="post">
                    ...
                    <div class="modal modal-danger fade" id="add5">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Are You Sure You Want To Add This Image For <strong>{{$branch->id}}</strong></p>
                                </div>
                                <div class="modal-footer">
                                    <form action="{{adminUrl("branch").'/show/'.$branch->id.'/addImage'}}" method="post"enctype="multipart/form-data">

                                        @csrf
                                        {{-- <input type="hidden"name="image"value="{{$product_image->image}}">--}}
                                        <input type="file" class="form-control" name="image_id[]" value=""multiple>
                                        <div class="d-flex flex-row">
                                            <button type="button" class="btn btn-outline-danger" data-dismiss="modal" style="margin-right: 5px">
                                                cancel
                                            </button>
