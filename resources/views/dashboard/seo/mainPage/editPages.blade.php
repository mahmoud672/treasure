...
@section('content')
    ...
    <section class="content">
        ...
        <form role="form" action="{{adminUrl('seo/website-page/edit/'.$page->id )}}" enctype="multipart/form-data" method="post">
            @csrf
            @method('patch')
{{--
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="url" disabled id="exampleInputEmail1" placeholder="Enter Clinic URL" value="{{$page->url}}">
                                ...
                                <div class="col-lg-6 mt-5">
                                    ...
                                    <textarea class="textarea" placeholder="Enter Page Description" name="description"
                                              style="width: 100%; resize: none; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$page->description}}</textarea>
