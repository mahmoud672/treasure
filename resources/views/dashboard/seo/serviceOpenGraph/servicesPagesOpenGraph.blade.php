...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Services Pages Open Graphs
            <small>All Services Pages Open Graphs</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{adminUrl('/')}}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{adminUrl('/seo/clinics-pages-open-graph')}}"> Services Pages Open Graphs</a></li>
            ...
            <div class="col-md-12">
                <div class="box box-primary" style="padding: 15px">
                    <div class="box-header with-border">
                        <h3 class="box-title">All Services Pages Open Graphs Info</h3>
                    </div>
