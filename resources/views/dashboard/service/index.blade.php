...
@section('customizedScript')
    ...
    <script>
        ...
        {
            $("#create_service_btn").attr("href","{{adminUrl("service/create?type=products")}}");
        }
    </script>
@endsection
            ...
            <div class="col-md-12">
                <div class="box box-primary" style="padding: 15px">
                    <div class="box-header with-border">
                        ...
                        <a href="{{adminUrl('service/create')}}" id="create_service_btn" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New Service </a>
                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @if($services)
                            @foreach($services as $service)
                                <tr>
                                    <td>{{$service->id}}</td>
                                    <td><img src="{{$service->image_id ? assetPath($service->image->path) : assetPath('dashboard/img/picture.png')}}" style="width: 50px" alt="slide image" > </td>
                                    <td>{{$service->service_en->title}}</td>
                                   {{-- <td>{{str_limit($service->service_en->slug, 50, '...')}}</td>--}}
