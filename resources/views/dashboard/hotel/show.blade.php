...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">All Program Images</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary" style="padding: 15px">
                    <div class="box-header with-border">
                        <h3 class="box-title">All Images For This Program</h3>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Are You Sure You Want To Delete This Image of <strong>{{$hotel->id}}</strong></p>
                                </div>
                                <div class="modal-footer">
                                    <form action="{{adminUrl("hotel")}}/show/{{$hotel->id}}/deleteImage" method="post">
                    ...
                    <div class="modal modal-danger fade" id="add5">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Are You Sure You Want To Add This Image For <strong>{{$hotel->id}}</strong></p>
                                </div>
                                <div class="modal-footer">
                                    <form action="{{adminUrl("hotel").'/show/'.$hotel->id.'/addImage'}}" method="post"enctype="multipart/form-data">

                                        @csrf
                                        {{-- <input type="hidden"name="image"value="{{$product_image->image}}">--}}
                                        <input type="file" class="form-control" name="hotel_image[]" value=""multiple>
                                        <div class="d-flex flex-row">
                                            <button type="button" class="btn btn-outline-danger" data-dismiss="modal" style="margin-right: 5px">
                                                cancel
                                            </button>
