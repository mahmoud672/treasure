...
@section('title', $product->{'product_'.currentLang()}->title)
...
@section('open-graph')
    ...
    <meta property="og:url" content="{{url('/product')}}"/>
    ...
    <div class="auto-container">
        <div class="content-box">
            ...
            <ul class="bread-crumb clearfix">
                ...
                <li class="shape"></li>
                <li>{{__("trans.products")}}</li>

                <li class="shape"></li>
                <li>{{$product->lang->title}}</li>
            </ul>
        </div>
    </div>
</section>
                            ...
                            <ul class="category-list clearfix">
                                @if($anotherProducts)
                                    @foreach($anotherProducts as $anotherProduct)
                                        <li {{request()->is(url("/product/$anotherProduct->url") == url("/product/$anotherProduct->url"))}}>
                                            <h5><a href="{{url("/product/$anotherProduct->url")}}">{{$anotherProduct->lang->title}} </a></h5>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-12 video-column">
                                <div class="video-inner" style="background-image: url({{assetPath("website/images/resource/video-1.jpg")}});">
                                    <div class="video-content centred">
                                        <a href="{{$product->video->url}}" class="lightbox-image video-btn" data-caption=""><i class="far fa-play"></i></a>
