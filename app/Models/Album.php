...
class Album extends Model  {
    ...
    {
        return $this->hasOne(AlbumArabic::class, 'album_id','id')->withDefault();
    }

    public function album_en()
    {
        return $this->hasOne(AlbumEnglish::class, 'album_id','id')->withDefault();
    }

    public function lang()
    {
        if (currentLang() == 'en')
            return $this->album_en();
        return $this->album_ar();
