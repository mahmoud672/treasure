...
class Slider extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['image_id','type','video_id', 'url', 'created_by'];
    ...
    {
        return $this->belongsToMany(Image::class,'slider_images', 'slider_id', 'image_id');
    }
    ...
    {
        if (currentLang() == 'en')
            return $this->slider_en();
        return  $this->slider_ar();
    }
